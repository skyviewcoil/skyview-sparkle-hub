...
export const metadata: Metadata = {
  title: "תקרה מתוחה מוארת — תאורה אחידה ללא גופי תאורה",
  description:
    "תקרה מתוחה מוארת משלבת יריעה שקופה עם תאורת LED מאחור. תאורה אחידה ורכה שמחליפה נברשות וספוטים. התקנה מקצועית ואחריות.",
  alternates: { canonical: "/lighted-stretch-ceiling" },
};
    ...
    <>
      ...
      <ContentSection>
        ...
        <p className="mt-4 text-body text-sky-muted">
          התקרה המוארת בנויה משתי שכבות: מערך פסי LED צפופים שמותקנים מעל
          יריעה שקופה (translucent). האור עובר דרך היריעה ומתפזר באופן אחיד
          על פני כל שטח התקרה. התוצאה דומה לחלון סקיילייט — אור רך ומפוזר שממלא
          את החלל ללא בהיקויים.
        </p>
        <FeatureGrid
          items={[
      ...
      <ContentSection bg="light">
        ...
        <p className="mt-4 text-body text-sky-muted">
          תקרות מוארות מתאימות במיוחד לחדרי אמבטיה, מסדרונות, מרפאות, חנויות,
          לובי משרדים וכל חלל שרוצים בו תאורה אחידה ומעוצבת. זהו גם פתרון
          מצוין לחללים עם תקרות נמוכות — כי הוא לא דורש מקום לגופי תאורה בולטים.
        </p>
      </ContentSection>
