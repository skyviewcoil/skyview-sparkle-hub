...
export const metadata: Metadata = {
  title: "תקרה מתוחה לאמבטיה — פתרון עמיד מים מושלם",
  description:
    "תקרה מתוחה לאמבטיה עמידה ב-100% ללחות, עובש וקילוף. התקנה נקייה, מגוון גימורים ואחריות מלאה. הפתרון האידיאלי לחדרי רחצה.",
  alternates: { canonical: "/stretch-ceiling-bathroom" },
};
    ...
    <>
      ...
      <ContentSection>
        ...
        <p className="mt-4 text-body text-sky-muted">
          תקרות גבס באמבטיה סובלות מקילוף, עובש וכתמי רטיבות תוך שנים ספורות.
          תקרה מתוחה מ-PVC לא סופגת לחות, לא מפתחת עובש, ויכולה להחזיק עד
          100 ליטר מים במקרה של נזילה מהדירה מעל — ללא נזק ליריעה.
        </p>
        <FeatureGrid
          items={[
      ...
      <ContentSection bg="light">
        ...
        <p className="mt-4 text-body text-sky-muted">
          לחדר אמבטיה קטן מומלצת יריעה מבריקה שמגדילה את תחושת המרחב. לאמבטיה
          גדולה ומעוצבת, יריעת מט או סאטן נותנת מראה יוקרתי ושקט. ניתן גם
          להוסיף הדפס שמים, עננים או כל עיצוב אחר ליצירת חוויה ייחודית.
        </p>
      </ContentSection>
