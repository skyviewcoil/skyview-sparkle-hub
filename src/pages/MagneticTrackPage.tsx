...
export default function MagneticTrackPage() {
  return (
    <>
      ...
      <PageHero title="תקרה מתוחה עם מסילה מגנטית" subtitle="מסילה מגנטית שקועה בתקרה המתוחה מאפשרת לחבר, להזיז ולהחליף גופי תאורה בלחיצה — ללא כלים, ללא חורים וללא חשמלאי." />
