    ...
    <>
      ...
      <section className="section-spacing">
        <div className="section-container">
          <p className="text-body text-sky-muted text-center max-w-prose mx-auto">גלריית הפרויקטים בהקמה. בקרוב כאן יוצגו תמונות לפני/אחרי מפרויקטים אמיתיים. בינתיים, צרו קשר לצפייה בדוגמאות נוספות.</p>
        </div>
      </section>
