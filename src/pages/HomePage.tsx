...
const solutions = [
  { title: "תקרה מתוחה מט", text: "גימור חלק ואלגנטי ללא החזרי אור — לסלון, חדר שינה ומשרד.", href: "/stretch-ceiling-matte" },
  { title: "תקרה מתוחה מבריקה", text: "משטח מראה שמגדיל חללים קטנים ומוסיף עומק חזותי.", href: "/stretch-ceiling-glossy" },
  { title: "תקרה מתוחה מוארת", text: "שכבת תאורה אחידה שמחליפה גופי תאורה מסורתיים.", href: "/lighted-stretch-ceiling" },
  { title: "תקרה מתוחה עם הדפס", text: "הדפסה ישירה של תמונה, טקסטורה או עיצוב גרפי על יריעת התקרה.", href: "/printed-stretch-ceiling" },
  { title: "תקרה מתוחה אקוסטית", text: "ספיגת רעשים ושיפור אקוסטיקה — לקולנוע ביתי, משרדים ומסעדות.", href: "/acoustic-stretch-ceiling" },
];
      ...
      <section className="section-spacing bg-sky-light">
        <div className="section-container">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {solutions.map((s) => (
              <Link key={s.href} to={s.href} className="group block p-6 bg-white border border-sky-border hover:border-sky-navy/30 transition-colors">
        ...
        <div className="section-container">
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Link key={r.href} to={r.href} className="group block p-5 border border-sky-border bg-white hover:border-sky-navy/30 transition-colors text-center">
