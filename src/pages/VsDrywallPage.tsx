  ...
  return (
    <>
      ...
      <ContentSection bg="light">
        ...
        <p className="mt-4 text-body text-sky-muted">כשרוצים התקנה מהירה ללא אבק, עמידות במים, תקרה ללא סדקים לטווח ארוך, שילוב תאורה מתקדם, או כשצריך להסתיר תשתיות קיימות ללא הריסה.</p>
        <h2 className="mt-10 text-h2-mobile md:text-h2-desktop">מתי גבס עדיף?</h2>
        <p className="mt-4 text-body text-sky-muted">כשצריך לבנות מדפים, נישות או מבנים תלת-ממדיים בתקרה. כשרוצים לשלב עבודות גבס קיימות עם קירות.</p>
      </ContentSection>
      <ContentSection>
        <h2 className="text-h2-mobile md:text-h2-desktop">עמודים קשורים</h2>
        <ul className="mt-4 space-y-2 text-body">
          <li><Link to="/pricing" className="text-sky-navy hover:underline">מחירון תקרות מתוחות למ״ר</Link></li>
          ...
          <li><Link to="/stretch-ceiling-repair" className="text-sky-navy hover:underline">תיקון תקרה מתוחה</Link></li>
        </ul>
      </ContentSection>
