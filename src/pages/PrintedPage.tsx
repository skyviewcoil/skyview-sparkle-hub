  ...
  return (
    <>
      ...
      <ContentSection>
        ...
        <p className="mt-4 text-body text-sky-muted">ההדפסה מבוצעת בטכנולוגיית UV על גבי יריעת PVC ברזולוציה של עד 1440 DPI. הדיו עמיד לאור, לחות וניקוי — הצבעים נשמרים לאורך שנים ללא דהייה.</p>
        <FeatureGrid items={[
