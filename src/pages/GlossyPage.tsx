...
export default function GlossyPage() {
  return (
    <>
      ...
      <PageHero title="תקרה מתוחה מבריקה — מרחב כפול" subtitle="יריעה מבריקה (גלוסי) יוצרת השתקפות עדינה של החלל — כמו מראה על התקרה. האפקט מכפיל את תחושת הגובה ומרחיב חללים קטנים בצורה דרמטית." />
