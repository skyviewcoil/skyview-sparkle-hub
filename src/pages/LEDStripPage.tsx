  ...
  return (
    <>
      ...
      <ContentSection>
        ...
        <p className="mt-4 text-body text-sky-muted">פרופיל אלומיניום ייעודי מוטמע בתוך היריעה ומחזיק פס LED מתחת לשכבת דיפיוזר. התוצאה היא קו אור ישר ואחיד שנראה כאילו הוא מרחף בתוך התקרה.</p>
        <FeatureGrid items={[
