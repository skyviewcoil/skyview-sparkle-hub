...
export default function AboutPage() {
  return (
    <>
      ...
      <PageHero title="אודות SkyView" subtitle="SkyView היא חברה ישראלית המתמחה ביבוא, ייצור והתקנה של תקרות מתוחות. אנחנו עובדים עם החומרים האיכותיים ביותר מאירופה, מייצרים בהתאמה אישית, ומתקינים בכל רחבי ישראל." />
      <ContentSection>
