...
export default function LightedCeilingPage() {
  return (
    <>
      ...
      <PageHero title="תקרה מתוחה מוארת — התקרה היא גוף התאורה" subtitle="יריעה שקופה או חצי-שקופה עם שכבת תאורת LED מאחוריה. התוצאה: תקרה שמאירה באור אחיד ורך — ללא גופי תאורה בולטים, ללא צללים וללא נקודות חמות." image={IMAGES.glossyLed} imageAlt="תקרה מתוחה מוארת עם תאורת LED" />
      ...
      <ContentSection bg="light">
        ...
        <PageImage src={IMAGES.glossyAngle} alt="תקרה מוארת בחלל מסחרי" />
      </ContentSection>
